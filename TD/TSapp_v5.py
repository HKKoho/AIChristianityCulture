...
# Modify your create_assignment_draft function (around line 884)
...
def main():
    ...
    with st.sidebar:
        ...
        # Model selection
        # Model selection
        model_options = ["llama3.3", "deepseek-r1:32b", "qwq", "openthinker:32b", "gemma3:27b", "gpt-3.5-turbo", "gpt-4o", "gpt-o1"]
            ...
            with st.chat_message("assistant"):
                ...
                if st.session_state.app_mode == "Reading Q&A" and "retriever" in st.session_state and st.session_state.retriever:
                    ...
                    with st.spinner(f"Thinking using {st.session_state.model}..."):
                        ...
                        full_response = streaming_handler.text
