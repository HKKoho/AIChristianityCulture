...
def main():
    ...
    # Main content area
    cols = st.columns([3, 1]) if st.session_state.app_mode == "Document Q&A" and st.session_state.documents else [st.columns([1])[0], None]
    ...
    if st.session_state.app_mode == "Document Q&A" and st.session_state.documents and cols[1] is not None:
        with cols[1]:
