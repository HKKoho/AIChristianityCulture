    ...
    return (
      ...
      <div className="w-full max-w-4xl mx-auto p-6">
        ...
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
          ...
          <div className="p-8">
            <p className="text-lg text-gray-700 mb-6">{selectedRoute.description}</p>
                ...
                {selectedRoute.waypoints.map((waypoint, index) => (
                  <div key={index} className="flex gap-4">
                    ...
                    <div className="flex-grow">
                      <h3 className="text-lg font-bold text-gray-800 mb-1">{waypoint.name}</h3>
                      <p className="text-gray-600">{waypoint.description}</p>
                    </div>
                  </div>
                ))}
              </div>
