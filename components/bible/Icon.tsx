...
type IconName = 'book-open' | 'x' | 'check' | 'lightbulb' | 'unlock' | 'lock' | 'sparkles' | 'list' | 'loader';
...
const ICONS: Record<IconName, React.ReactElement> = {
  ...
  'lightbulb': (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 001.5-11.25H10.5a6.01 6.01 0 001.5 11.25v.25m0 0h.01M12 18v-5.25m0 0a6.01 6.01 0 00-1.5-11.25H10.5a6.01 6.01 0 00-1.5 11.25v.25m0 0h.01M12 18v-5.25m0 0a6.01 6.01 0 011.5-11.25H10.5a6.01 6.01 0 01-1.5 11.25v.25m0 0h.01" />
    </svg>
  ),
  'unlock': (
     <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 10.5V6.75a4.5 4.5 0 10-9 0v3.75M10.5 13.5V18c0 .414.336.75.75.75h3c.414 0 .75-.336.75-.75v-4.5M10.5 13.5h3.75" />
     </svg>
  ),
  'lock': (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
